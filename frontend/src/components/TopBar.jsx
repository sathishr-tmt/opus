// TopBar — theme toggle, notifications (users), and the shared profile menu.
import { Bell, Sun, Moon } from 'lucide-react';
import { ProfileMenu } from './ProfileMenu.jsx';

function TopBar({ showToast, gmailStatus, currentUser, setActivePage, onLogout, theme, onToggleTheme }) {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-14 items-center justify-end gap-3 border-b border-slate-200 bg-white/90 px-7 backdrop-blur">
      <button
